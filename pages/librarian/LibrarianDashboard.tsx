...
import { Clock, Printer, BookOpen, Users, AlertCircle, TrendingUp, Trophy, Filter, BarChart3, Download, PieChart } from 'lucide-react';
    ...
    const Overview = () => (
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <StatCard title="Acervo Total" value={dashboardStats.totalBooks} icon={<BookOpen size={24} />} color="indigo" onClick={() => setTab('books')} />
                <StatCard title="Leitores Ativos" value={dashboardStats.totalUsers} icon={<Users size={24} />} color="emerald" onClick={() => setTab('users')} />
                <StatCard title="Empréstimos Ativos" value={dashboardStats.activeLoans} icon={<TrendingUp size={24} />} color="amber" onClick={() => setTab('loans')} />
                <StatCard title="Atrasos" value={dashboardStats.overdueLoans} icon={<AlertCircle size={24} />} color="rose" onClick={handleOverdueClick} />
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    {/* Top Books (Moved here since Chart was removed) */}
        ...
        return (
            <div className="space-y-6">
                ...
                <div className="bg-white rounded-xl shadow-sm border overflow-hidden print:border-none print:shadow-none">
                    {/* Header only visible for Print - WHITE BACKGROUND */}
                    <div className="hidden print:block mb-4">
                         <div className="bg-white text-gray-900 p-8 text-center print-color-adjust-exact border-b-2 border-indigo-600">
                             <div className="flex items-center justify-center gap-4 mb-2">
                                {/* Use logo URL directly - Original Colors */}
